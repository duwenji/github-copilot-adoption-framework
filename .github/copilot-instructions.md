...
- 設定: `.github/skills-config/ebook-build/github-copilot-adoption-framework.build.json`
- メタデータ: `.github/skills-config/ebook-build/github-copilot-adoption-framework.metadata.yaml`
