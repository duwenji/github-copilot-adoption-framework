[CmdletBinding()]
param(
    [string]$ConfigFile = '.github/skills-config/ebook-build/github-copilot-adoption-framework.build.json'
)
...
$enablePageListValue = Get-ConfigValue -Config $config -Name 'enablePageList'
