...
# GCAF（GitHub Copilot Adoption Framework）v1.0 {#chapter-01-framework}

## GCAF（GitHub Copilot Adoption Framework）v1.0 {#section-01-framework-01-overview}
...
# Governance {#chapter-02-governance}

## Copilot利用ポリシーひな型（禁止事項・責任分界・例外手続き） {#section-02-governance-01-policy-template}
...
## Content Exclusion 推奨パターン集（GitHub Copilot向け） {#section-02-governance-02-content-exclusion}
...
# Operations {#chapter-03-operations}

## レビュー観点チェックリスト（GitHub Copilot利用時） {#section-03-operations-01-review-checklist}
...
## チャット参加者・スラッシュコマンド・チャット変数の詳細リスト {#section-03-operations-02-chat-reference}
